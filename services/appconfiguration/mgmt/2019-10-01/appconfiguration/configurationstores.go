...
// DeleteKeyValue lists a configuration store key-value.
// Parameters:
// resourceGroupName - the name of the resource group to which the container registry belongs.
// configStoreName - the name of the configuration store.
// setKeyValueParameters - the parameters for retrieving a key-value.
func (client ConfigurationStoresClient) DeleteKeyValue(ctx context.Context, resourceGroupName string, configStoreName string, setKeyValueParameters SetKeyValueParameters) (result GetKeyValueParameters, err error) {
	// if tracing.IsEnabled() {
	...
	request, _ := http.NewRequest("DELETE", reqURL, bytes.NewBuffer(jsonValue))
